...
quarkus dev -Dquarkus.args="image --template-name generate-image-blog-post --title Gemini_CLI --name JeanPhi_Baconnais -o output.png --photo1 images/people/jeanphi-baconnais.png" 
